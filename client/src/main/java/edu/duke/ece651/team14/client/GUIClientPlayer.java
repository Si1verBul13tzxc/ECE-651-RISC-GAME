...
import edu.duke.ece651.team14.client.controller.ChatController;
...
import edu.duke.ece651.team14.client.controller.SettingsController;
...
public class GUIClientPlayer extends ClientPlayer {
   ...
   */
  public GUIClientPlayer(ClientChatRoom room,GameModel model, Socket clientSocket, Communicator communicator, BufferedReader inputSource,
      PrintStream outPrintStream) {
    super(clientSocket, communicator, inputSource, outPrintStream);
    this.model = model;
    this.chatroom = room;
    Thread chatRoomThread = new Thread(this.chatroom,"chat room thread");
  ...
  public void setStage(Stage window) throws Exception {
    ...
    controller_initializer.put(ChatController.class, new ChatController(this.chatroom));
    controller_initializer.put(SettingsController.class, new SettingsController(model));
  }
  ...
  public void setChatRoomGameID() throws IOException{
    this.chatroom.init_gameid(String.valueOf(this.gameid));
  }
